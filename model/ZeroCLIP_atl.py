...
import torch
# import clip
import clip_autotunelayer as clip
...
class CLIPTextGenerator:
    ...
    # added
    def get_img_feature_all(self, img_path, weights, mask_bi=None, start_layer=None):
        # imgs = [Image.open(x) for x in img_path]
        ...
        with torch.no_grad():
            ...
            # image_fts = [self.clip.encode_image(x,mask_bi,start_layer) for x in clip_imgs]
